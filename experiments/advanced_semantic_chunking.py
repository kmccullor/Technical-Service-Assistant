...
class AdvancedSemanticChunker:
    ...
    def __init__(
        ...
        logger.info(f"Semantic chunker initialized: max_size={max_chunk_size}, "
    ...
    def chunk_document(
        ...
        text: str, 
        document_name: str,
        content_pattern: ContentPattern = ContentPattern.GENERAL_DOCUMENT
    ) -> List[SemanticChunk]:
        ...
        for i, line in enumerate(lines):
            ...
            if heading_match:
                ...
                structure["headings"].append({
                    ...
                    "level": level,
                    "title": title,
                    "hierarchy": section_hierarchy[:level-1] + [title]
                })
