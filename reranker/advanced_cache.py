...
class AdvancedCache:
    ...
    def __init__(self):
        ...
        self.enabled = os.getenv("ENABLE_ADVANCED_CACHE", "true").lower() in {
            "1", "true", "yes"
        }
    ...
    def cache_inference(self, model: str, system_prompt: str, user_prompt: str, 
                       response: str) -> bool:
        """
    ...
    def cache_chunk_metadata(self, document_id: int, chunk_id: int, 
