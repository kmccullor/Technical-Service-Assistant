...
class DocumentQueryHandler:
    ...
    def _extract_parameters(self, query_type: DocumentQueryType, 
                          match: re.Match, full_query: str) -> Dict[str, str]:
    ...
    def generate_response_prompt(self, query_type: DocumentQueryType, 
                               params: Dict[str, str], results: Dict) -> str:
...
Format this information in a conversational, helpful way for the user."""
        ...
        elif query_type in [DocumentQueryType.LIST_ALL, DocumentQueryType.LIST_BY_TYPE, 
                           DocumentQueryType.LIST_BY_PRODUCT, DocumentQueryType.SEARCH_DOCUMENTS]:
...
These documents are ready for search and can provide answers to your questions."""
        ...
        return "I found some document information, but I'm not sure how to present it. Could you rephrase your question?"
