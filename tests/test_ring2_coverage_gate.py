...
def run_coverage_gate(args):
    ...
    gate = Ring2CoverageGate(strict_mode=args.strict, target_modules=args.modules if args.modules else None)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--strict", action="store_true", help="Enforce coverage targets (default: relaxed mode)")
    parser.add_argument(
        "--modules",
        nargs="+",
