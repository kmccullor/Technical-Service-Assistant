    ...
    def test_privacy_filtering_in_search(self, db_connection):
        ...
        with db_connection.cursor() as cursor:
            try:
                ...
                assert any(
                    "public content" in content for content in public_content
                ), "Public search should find public content"
                assert any(
                    "private content" in content for content in private_content
                ), "Private search should find private content"
...
class TestPrivacyAPIIntegration:
    ...
    def test_api_models_have_privacy_fields(self):
        ...
        from reranker.app import HybridSearchRequest, RAGChatRequest, RerankRequest
