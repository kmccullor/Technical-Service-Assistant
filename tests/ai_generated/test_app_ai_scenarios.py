...
class TestAppAIScenarios:
    ...
    def test_api_post_success(self):
        ...
        endpoint = "/api/test"
        headers = {'Content-Type': 'application/json'}
        payload = {'query': 'What causes API response time degradation?', 'parameters': {'max_results': 5, 'include_metadata': True, 'timeout': 60}}
    ...
    def test_api_put_success(self):
        ...
        endpoint = "/api/test"
        headers = {'Content-Type': 'application/json'}
        payload = {'query': 'Explain the database schema for document storage', 'parameters': {'max_results': 5, 'include_metadata': True, 'timeout': 10}}
    ...
    def test_api_patch_success(self):
        ...
        endpoint = "/api/test"
        headers = {'Content-Type': 'application/json'}
        payload = {'query': 'Explain the database schema for document storage', 'parameters': {'max_results': 20, 'include_metadata': True, 'timeout': 10}}
