...
class TestPDFProcessingPipeline:
    ...
    def test_pdf_upload_and_processing(self, temp_upload_dir, sample_pdf_content):
        ...
        with patch("requests.post") as mock_post:
            mock_post.return_value.json.return_value = {"embedding": [0.1] * 1280}
    ...
    def test_embedding_generation(self):
        ...
        with patch("requests.post") as mock_post:
            ...
            mock_post.return_value.json.return_value = {"embedding": [0.1] * 1280, "model": "nomic-embed-text:v1.5"}
    ...
    def test_search_functionality(self, mock_search_results):
        ...
        with patch("psycopg2.connect") as mock_connect:
            ...
            # Mock search results
            mock_cursor.fetchall.return_value = [("Test content", {"document_name": "test.pdf"}, 0.95)]
