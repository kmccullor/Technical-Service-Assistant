...
def test_reset_password_success(client):
    ...
    payload = {"token": "reset-token-123", "new_password": "NewSecurePass123!", "confirm_password": "NewSecurePass123!"}
...
def test_reset_password_validation_error(client):
    ...
    payload = {"token": "expired-token", "new_password": "NewSecurePass123!", "confirm_password": "NewSecurePass123!"}
