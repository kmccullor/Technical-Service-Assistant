    ...
    def test_password_strength_validation(self):
        ...
        try:
            request = ChangePasswordRequest(
                current_password="old_password", new_password=strong_password, confirm_password=strong_password
            )
    ...
    def test_password_confirmation_mismatch(self):
        ...
        with pytest.raises(ValueError, match="New password and confirmation do not match"):
            ChangePasswordRequest(
                current_password="old_password", new_password="NewPass123!", confirm_password="DifferentPass123!"
            )
    ...
    def test_weak_password_validation(self):
        ...
        for weak_pwd in weak_passwords:
            with pytest.raises(ValueError):
                ChangePasswordRequest(current_password="old_password", new_password=weak_pwd, confirm_password=weak_pwd)
...
class TestPasswordChangeEndpoint:
    ...
    def test_change_password_endpoint_success(self, test_app, mock_dependencies):
        ...
        with patch("rbac_endpoints.get_current_active_user", return_value=mock_user), patch(
            "rbac_endpoints.get_auth_manager", return_value=mock_auth_manager
        ):
