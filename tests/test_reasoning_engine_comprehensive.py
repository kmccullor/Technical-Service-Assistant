...
class TestKnowledgeSynthesis:
    ...
    def test_multi_source_synthesis(self):
        ...
        try:
            ...
            sources = [
                {"content": "Sensus AMI meters use FlexNet for communication", "source": "manual.pdf", "confidence": 0.9},
                {"content": "FlexNet technology enables two-way communication", "source": "tech_spec.pdf", "confidence": 0.8},
                {"content": "Communication range is typically 1-2 miles", "source": "field_guide.pdf", "confidence": 0.7}
            ]
