...
def test_classification_accuracy():
    ...
    test_cases = [
        {"pattern": "%Release Notes%", "expected_type": "release_notes", "description": "Release Notes Documents"},
        {
            "pattern": "%Installation Guide%",
            "expected_type": "installation_guide",
            "description": "Installation Guide Documents",
        },
        {"pattern": "%User Guide%", "expected_type": "user_guide", "description": "User Guide Documents"},
        {
            "pattern": "%Integration Guide%",
            "expected_type": "integration_guide",
            "description": "Integration Guide Documents",
        },
        {"pattern": "%Security%", "expected_type": "security_guide", "description": "Security Guide Documents"},
        {
