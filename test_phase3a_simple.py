...
class Phase3ATestSuite:
    ...
    def create_mock_image(self, width=400, height=300, content_type="diagram") -> Image.Image:
        ...
        if content_type == "diagram":
            ...
            for i in range(5):
                height_bar = 50 + i * 20
                draw.rectangle([50 + i * 60, 200 - height_bar, 90 + i * 60, 200], fill="blue", outline="black")
    ...
    async def test_vision_model_manager(self) -> bool:
        ...
        try:
            ...
            description, confidence = await vision_manager.describe_image(test_image, context="network configuration")
    ...
    async def test_image_extraction_pipeline(self) -> bool:
        ...
        try:
            from phase3a_multimodal_simple import MockImageExtractor, VisionModelManager
            ...
            test_description = (
                "Network diagram showing router and switch connections with TCP/IP protocol configuration"
            )
    ...
    async def test_phase3a_system_integration(self) -> bool:
        ...
        try:
            ...
            test_queries = ["network configuration", "system performance table", "technical diagram"]
            ...
            for query in test_queries:
                try:
                    ...
                    logger.info(
                        f"Query '{query}': {len(results)} results, " f"confidence: {metrics.confidence_score:.3f}"
                    )
                except Exception as e:
