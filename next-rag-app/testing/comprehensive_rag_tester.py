...
class RAGSystemTester:
    ...
    def test_chat_endpoint(self, question: str, test_name: Optional[str] = None) -> TestResult:
        ...
        try:
            ...
            response = self.session.post(
                f"{self.base_url}/api/chat", json=payload, timeout=30, headers={"Content-Type": "application/json"}
            )
    ...
    def parse_streaming_response(self, response_text: str) -> Dict:
        ...
        data = {"conversation_id": None, "sources": [], "tokens": [], "confidence": None}
    ...
    def test_search_functionality(self) -> List[TestResult]:
        ...
        search_tests = [
            {"question": "What is RNI?", "expected_sources": True, "test_name": "Basic RNI Query"},
            {"question": "How to install RNI?", "expected_sources": True, "test_name": "Installation Query"},
            {"question": "RNI configuration parameters", "expected_sources": True, "test_name": "Configuration Query"},
            {
                "question": "completely unrelated query about cooking recipes",
                "expected_sources": False,
                "test_name": "Unrelated Query Test",
            },
            {"question": "", "expected_sources": False, "test_name": "Empty Query Test"},
            {"question": "a" * 1000, "expected_sources": False, "test_name": "Very Long Query Test"},
        ]
    ...
    def test_edge_cases(self) -> List[TestResult]:
        ...
        edge_cases = [
            ...
            {"test_type": "empty_messages", "payload": {"messages": []}, "test_name": "Empty Messages Array"},
        ]
    ...
    def generate_report(self, all_results: Dict[str, List[TestResult]]) -> Dict[str, Any]:
        ...
        report = {"timestamp": timestamp, "test_summary": {}, "detailed_results": {}, "recommendations": []}
        ...
        if summary["avg_response_time"] > 5.0:
            report["recommendations"].append(
                "⚠️ Average response time above 5 seconds - consider performance optimization"
            )
