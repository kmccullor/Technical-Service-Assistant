            ...
            for i, scenario in enumerate(test_scenarios):
                try:
                    ...
                    mock_result = SearchResult(
                        content=scenario["content"], document_name="test.pdf", metadata={}, score=0.8, method="test"
                    )

                    # Calculate confidence
                    confidence, analysis = confidence_scorer.calculate_confidence(scenario["query"], [mock_result])
...
Parameter: RETRY_COUNT = 3
            ...
            # Test chunking
            chunks = chunker.chunk_document(test_doc, "test_guide.pdf", ContentPattern.TECHNICAL_MANUAL)
